...
print("### HYBRID FULL COMBINED FAILURE CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "combined_failure", "full_combined_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_full_combined_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_full_combined_failure_summary.csv")
