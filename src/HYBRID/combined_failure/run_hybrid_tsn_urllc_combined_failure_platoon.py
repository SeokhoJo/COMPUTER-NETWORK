...
print("### HYBRID TSN-URLLC COMBINED FAILURE CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "combined_failure", "tsn_urllc_combined_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_urllc_combined_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_urllc_combined_failure_summary.csv")
