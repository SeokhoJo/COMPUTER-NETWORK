...
print("### HYBRID TSN-DETNET COMBINED FAILURE CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "combined_failure", "tsn_detnet_combined_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_detnet_combined_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_detnet_combined_failure_summary.csv")
