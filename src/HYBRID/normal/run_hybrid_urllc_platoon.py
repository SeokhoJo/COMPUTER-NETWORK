...
print("### HYBRID URLLC CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "normal", "urllc")

LOG_DIR = os.path.join(RESULT_DIR, "hy_urllc_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_urllc_summary.csv")
