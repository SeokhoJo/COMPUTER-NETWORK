...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "normal", "tsn_urllc")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_urllc_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_urllc_summary.csv")
