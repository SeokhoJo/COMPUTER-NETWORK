...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "normal", "baseline")

LOG_DIR = os.path.join(RESULT_DIR, "hy_baseline_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_baseline_summary.csv")
