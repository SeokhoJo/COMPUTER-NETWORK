...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "normal", "tsn_detnet")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_detnet_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_detnet_summary.csv")
