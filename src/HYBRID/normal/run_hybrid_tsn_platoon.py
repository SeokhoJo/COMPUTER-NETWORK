...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "normal", "tsn")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_summary.csv")
