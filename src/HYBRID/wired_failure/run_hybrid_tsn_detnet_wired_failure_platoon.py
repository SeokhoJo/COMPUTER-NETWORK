...
print("### HYBRID TSN-DETNET WIRED FAILURE CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "wired_failure", "tsn_detnet_wired_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_detnet_wired_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_detnet_wired_failure_summary.csv")
