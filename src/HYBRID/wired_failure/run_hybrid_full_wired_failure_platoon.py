...
print("### HYBRID FULL WIRED FAILURE CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "wired_failure", "full_wired_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_full_wired_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_full_wired_failure_summary.csv")
