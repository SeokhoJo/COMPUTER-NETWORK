...
print("### HYBRID TSN WIRED FAILURE CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "wired_failure", "tsn_wired_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_wired_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_wired_failure_summary.csv")
