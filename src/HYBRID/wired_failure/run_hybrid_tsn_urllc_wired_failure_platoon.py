...
print("### HYBRID TSN-URLLC WIRED FAILURE CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "wired_failure", "tsn_urllc_wired_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_urllc_wired_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_urllc_wired_failure_summary.csv")
            ...
            if (lead_dist - all_visible_reference_distance) >= EVENT_EXTRA_TRAVEL_AFTER_ALL_VISIBLE:
                ...
                for i in range(1, VEHICLE_COUNT):
                    ...
                    if node in receivers:
                        ...
                        print(
                            f"[TSN-URLLC] {veh} received via TSN backbone, "
