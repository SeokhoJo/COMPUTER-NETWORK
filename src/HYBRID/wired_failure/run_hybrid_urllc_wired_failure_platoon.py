...
print("### HYBRID URLLC WIRED FAILURE CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "wired_failure", "urllc_wired_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_urllc_wired_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_urllc_wired_failure_summary.csv")
