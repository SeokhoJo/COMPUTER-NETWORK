...
print("### HYBRID TSN DETNET CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "wireless_failure", "tsn_detnet_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_detnet_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_detnet_failure_summary.csv")
