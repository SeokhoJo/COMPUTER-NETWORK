...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "wireless_failure", "tsn_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_failure_summary.csv")
...
DEFAULT_WIRED_DELAY_SEC = 0.000081774
