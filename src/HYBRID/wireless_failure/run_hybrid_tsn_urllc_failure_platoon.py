...
print("### HYBRID TSN-URLLC-FAILURE CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "wireless_failure", "tsn_urllc_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_tsn_urllc_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_tsn_urllc_failure_summary.csv")
