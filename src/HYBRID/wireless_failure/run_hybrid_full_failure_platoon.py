...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "wireless_failure", "full_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_full_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_full_failure_summary.csv")
