...
print("### HYBRID URLLC FAILURE CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "hybrid", "wireless_failure", "urllc_failure")

LOG_DIR = os.path.join(RESULT_DIR, "hy_urllc_failure_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "hy_urllc_failure_summary.csv")
