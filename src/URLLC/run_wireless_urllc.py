...
print("### WIRELESS URLLC ONLY CODE RUNNING ###")
...
RESULT_DIR = os.path.join(RESULT_ROOT, "wireless", "urllc")

LOG_DIR = os.path.join(RESULT_DIR, "urllc_logs")
SUMMARY_FILE = os.path.join(RESULT_DIR, "urllc_summary.csv")
